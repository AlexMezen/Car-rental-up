...
function Welcome() {
    ...
    let allPrices= cars.map((el)=>{
        return el['pricePerDay']
    });
    const totalPrice = allPrices.reduce((accum,val)=>{
       return  accum+=val;
    })
    ...
    return(
        ...
        <div className="down-header">
            ...
            <div className="titleWrapper">
                <p className="title">Car rental in <span className="sp">Kharkiv</span></p>
                <p className="subTitle">Total {cars.length} cars with average cost {result}$ per day </p>
            </div>
            </div>
